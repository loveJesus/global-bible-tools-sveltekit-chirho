...
const FONT_THAI_PATH_CHIRHO = joinChirho(process.cwd(), 'static/fonts-chirho/NotoSansThaiMergedChirho.ttf');
...
const FONT_GUJARATI_PATH_CHIRHO = joinChirho(process.cwd(), 'static/fonts-chirho/NotoSansGujaratiMergedChirho.ttf');
