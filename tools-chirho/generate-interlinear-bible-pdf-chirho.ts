...
const BOOK_NAMES_BY_LANGUAGE_CHIRHO: Record<string, Record<number, string>> = {
	...
	amh: {
		...
		54: '1ኛ ጢሞቴዎስ', 55: '2ኛ ጢሞቴዎስ', 56: 'ቲቶ', 57: 'ፊልሟና', 58: 'ዕብራውያን',
	...
	guj: {
		...
		6: 'યહોશુઆ', 7: 'ન્યાયાધીશો', 8: 'રૂથ', 9: '૧ શમુએલ', 10: '૨ શમુએલ',
		11: '૧ રાજાઓ', 12: '૨ રાજાઓ', 13: '૧ કાળવૃત્તાંત', 14: '૨ કાળવૃત્તાંત',
		15: 'એઝરા', 16: 'નહેમ્યા', 17: 'એસ્તેર', 18: 'અયૂબ', 19: 'ગીતશાસ્ત્ર',
		20: 'નીતિવચનો', 21: 'સભાશિક્ષક', 22: 'શ્રેષ્ઠગીત', 23: 'યશાયા', 24: 'યિર્મેયા',
		25: 'વિલાપગીતો', 26: 'યહેઝકેલ', 27: 'દાનિયેલ', 28: 'હોશિયા', 29: 'યોએલ',
		30: 'આમોસ', 31: 'ઓબાદ્યા', 32: 'યૂના', 33: 'મીખા', 34: 'નાહૂમ',
		35: 'હબાક્કૂક', 36: 'સફાન્યા', 37: 'હાગ્ગાય', 38: 'ઝખાર્યા', 39: 'માલાખી',
		40: 'માથ્થી', 41: 'માર્ક', 42: 'લૂક', 43: 'યોહાન', 44: 'પ્રેરિતોનાં કૃત્યો',
		45: 'રોમનોને પત્ર', 46: '૧ કરિંથીઓને', 47: '૨ કરિંથીઓને', 48: 'ગલાતીઓને', 49: 'એફેસીઓને',
		50: 'ફિલિપીઓને', 51: 'કલોસ્સીઓને', 52: '૧ થેસ્સલોનિકીઓને', 53: '૨ થેસ્સલોનિકીઓને',
		54: '૧ તિમોથીને', 55: '૨ તિમોથીને', 56: 'તિતસને', 57: 'ફિલેમોનને', 58: 'હિબ્રૂઓને',
		59: 'યાકૂબ', 60: '૧ પિતર', 61: '૨ પિતર', 62: '૧ યોહાન', 63: '૨ યોહાન',
		64: '૩ યોહાન', 65: 'યહૂદા', 66: 'પ્રકટીકરણ'
	},
	tha: {
		...
		20: 'สุภาษิต', 21: 'ปัญญาจารย์', 22: 'เพลงซาโลมอน', 23: 'อิสยาห์', 24: 'เยเรมีย์',
		25: 'เพลงคร่ำครวญ', 26: 'เอเสเคียล', 27: 'ดาเนียล', 28: 'โฮเชยา', 29: 'โยเอล',
		30: 'อาโมส', 31: 'โอบาดีย์', 32: 'โยนาห์', 33: 'มีคาห์', 34: 'นาฮูม',
		35: 'ฮาบากุก', 36: 'เศฟันยาห์', 37: 'ฮักกัย', 38: 'เศคาริยาห์', 39: 'มาลาคี',
		40: 'มัทธิว', 41: 'มาระโก', 42: 'ลูกา', 43: 'ยอห์น', 44: 'กิจการ',
		45: 'โรม', 46: '1 โครินธ์', 47: '2 โครินธ์', 48: 'กาลาเทีย', 49: 'เอเฟซัส',
		50: 'ฟีลิปปี', 51: 'โคโลสี', 52: '1 เธสะโลนิกา', 53: '2 เธสะโลนิกา',
		54: '1 ทิโมธี', 55: '2 ทิโมธี', 56: 'ทิตัส', 57: 'ฟีเลโมน', 58: 'ฮีบรู',
		59: 'ยากอบ', 60: '1 เปโตร', 61: '2 เปโตร', 62: '1 ยอห์น', 63: '2 ยอห์น',
		64: '3 ยอห์น', 65: 'ยูดา', 66: 'วิวรณ์'
	}
};
...
const UI_LABELS_BY_LANGUAGE_CHIRHO: Record<string, { tocChirho: string; otChirho: string; ntChirho: string }> = {
	...
	guj: { tocChirho: 'અનુક્રમણિકા', otChirho: 'જૂનો કરાર', ntChirho: 'નવો કરાર' },
	tha: { tocChirho: 'สารบัญ', otChirho: 'พันธสัญญาเดิม', ntChirho: 'พันธสัญญาใหม่' }
};
